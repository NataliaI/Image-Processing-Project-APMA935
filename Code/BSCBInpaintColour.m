...
% Plotting initial image wiht mask
%------------------------------------
figure;
for k=1:3
    ColourI=I(:,:,k);
...
imagesc(I); axis off; title('Initial Image', 'FontSize', 12);

saveas(gca, strcat('BSCBOutput/',FigNum,'InitialImage.eps'),'epsc'); 
...
saveas(gca, strcat('BSCBOutput/',FigNum,'InpaintedImage.eps'),'epsc'); 
